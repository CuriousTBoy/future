 ...
 * @Version 1.0
 */
public class DrectConsumerA {

  private static final String EXCHANGE_NAME = "publish_subscribe_exchange_direct";
  private static final String QUEUE_NAME = "routing_direct_queue_name_A";
  //binding key
  ...
  public static void main(String[] args) throws Exception {
    ...
    channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, EXCHANGE_ROUTE_KEY2);
